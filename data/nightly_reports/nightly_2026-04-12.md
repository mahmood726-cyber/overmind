# Nightly Verification Report - 2026-04-12

**5/50 CERTIFIED** (0 cached) | 18 FAIL | 9 REJECT | 18 single-witness (PASS)
...
**Top proven fixes:**
- `TIMEOUT:advanced-n`: Check for WMI deadlock (Python 3.13), infinite loop, or slow (33% confidence)

## Certified

| Project | Risk | Math | Witnesses | Bundle Hash | Time |
|---------|------|------|-----------|-------------|------|
| truthcert-meta2-prototype | high | 8 | 2 | `ba31ab8a47b4963f` | 32.1s |
| ctgov-search-strategies | high | 7 | 2 | `db64f99f154ae822` | 18.5s |
| meta-paradigm-shift | high | 5 | 2 | `623c25928052d7f9` | 6.1s |
| four_limb_synthesis | high | 2 | 2 | `dff202b64ac3b783` | 12.1s |
| truthcert-openclaw-supermemory-stack | high | 2 | 2 | `e7ec4136ee89b947` | 18.1s |

## Single-Witness Pass

| Project | Risk | Math | Time |
|---------|------|------|------|
| esc-acs-living-meta | high | 20 | 6.2s |
| overmind | high | 20 | 14.3s |
| lec_phase0_project | high | 16 | 34.2s |
| rct-extractor-v2 | high | 15 | 18.2s |
| EvidenceOracle | high | 14 | 12.3s |
| globalst | high | 14 | 16.2s |
| hfpef_registry_synth | high | 14 | 10.3s |
| BayesianMA | high | 13 | 36.3s |
| asreview_5star | high | 12 | 18.2s |
| experimental-meta-analysis | high | 11 | 50.2s |
| moonshot-evidence-lab | high | 11 | 6.1s |
| Transcendent-Meta-Analysis-Lab | high | 11 | 14.1s |
| cardio-ctgov-living-meta-portfolio | high | 10 | 4.1s |
| registry_first_rct_meta | high | 10 | 4.2s |
| metasprint-cardio-universe | high | 9 | 4.2s |
| Denominator_Calibrated_Living_NMA | high | 8 | 4.2s |
| GWAM | high | 7 | 10.1s |
...
| Witness | Verdict | Details |
|---------|---------|---------|
| test_suite | PASS | ...............                                                          [100%] 15 passed in 10.53s  |
| smoke | FAIL | validation.benchmark_lu_ades_2004: import timed out validation.forensic_simulation_study: import timed out validation.ru |
...
| Witness | Verdict | Details |
|---------|---------|---------|
| test_suite | PASS | .                                                                        [100%] 1 passed in 0.04s  |
...
| Witness | Verdict | Details |
|---------|---------|---------|
| test_suite | PASS | .......                                                                  [100%] 7 passed in 1.87s  |
...
| Witness | Verdict | Details |
|---------|---------|---------|
| test_suite | PASS | .                                                                        [100%] 1 passed in 2.86s  |
...
| Witness | Verdict | Details |
|---------|---------|---------|
| test_suite | FAIL |      	chromedriver!GetHandleVerifier [0x7ff77930facc+3a88c] E       	chromedriver!GetHandleVerifier [0x7ff7792f3634+1e3f |
...
selenium_simple_test: import timed out
...
Dream: 83 merges, 0 archives, 282->199 memories