...
REVIEW_INSTRUCTION_CALIBRATED = (
    ...
    "  - a NON-SIGNIFICANT result. A 95% CI that crosses/includes 1.0, or a wide "
    "interval, is about precision, not direction. If the point estimate agrees in "
    "direction with the conclusion, a CI spanning 1.0 is NOT a defect.\n"
