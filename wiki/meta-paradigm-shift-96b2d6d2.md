...
**Bundle hash:** 47ab4e0539d41811 | **Risk:** high | **Math:** 5
...
- **Path:** C:\Projects\meta-paradigm-shift
- **Type:** browser_app
- **Stack:** css, javascript
- **Test command:** `python -m pytest tests/test_meta_paradigm_shift.py -q`
...
| 2026-04-15 | CERTIFIED | 2/2 | 3.7s | 439712f5b73c3979 |
