...
**Bundle hash:** e90a7d7bef82086f | **Risk:** high | **Math:** 14
...
| test_suite | PASS | 5.1s | .                                                                        [100%]
 |
| smoke | PASS | 33.3s | 40 modules imported OK |
| semgrep | PASS | 194.9s | semgrep findings: ERROR=0 WARNING=0 INFO=0; engine errors=7 |
