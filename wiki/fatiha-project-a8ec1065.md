...
**Last verified:** 2026-05-04 21:23 UTC | **Verdict:** CERTIFIED (4/4 witnesses agree PASS)
**Bundle hash:** d71a9eebf7feedfd | **Risk:** high | **Math:** 11

## Health

| Witness | Verdict | Time | Detail |
|---------|---------|------|--------|
| test_suite | PASS | 2.1s | s...                                                                     [100%]
 |
| smoke | SKIP | 0.0s | skipped |
| semgrep | PASS | 12.2s | semgrep findings: ERROR=0 WARNING=0 INFO=0; engine errors=0 |
| pip_audit | SKIP | 0.0s | skipped |
| numerical | PASS | 1.4s | 7 values within tolerance |
