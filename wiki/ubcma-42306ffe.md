...
**Bundle hash:** f0b0205984460e7e | **Risk:** high | **Math:** 11
...
| test_suite | PASS | 5.8s | .......                                                                  [100%]
 |
| smoke | PASS | 55.9s | 18 modules imported OK |
| semgrep | PASS | 14.2s | semgrep findings: ERROR=0 WARNING=0 INFO=0; engine errors=0 |
| pip_audit | SKIP | 0.0s | skipped |
| numerical | PASS | 2.6s | 2 values within tolerance |
