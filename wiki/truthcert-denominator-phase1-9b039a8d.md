...
**Bundle hash:** 9033dc23a9b7e7de | **Risk:** high | **Math:** 10
...
| test_suite | PASS | 5.4s | .                                                                        [100%]
 |
| smoke | PASS | 14.3s | 14 modules imported OK |
| semgrep | PASS | 12.7s | semgrep findings: ERROR=0 WARNING=0 INFO=0; engine errors=0 |
| pip_audit | PASS | 42.7s | pip-audit findings: 0 vulnerabilities across 18 dep(s); scope: requirements file |
| numerical | PASS | 1.6s | 5 values within tolerance |
...
| 2026-04-19 | CERTIFIED | 3/3 | 13.9s | 6e2d0f6b6acf9830 |
