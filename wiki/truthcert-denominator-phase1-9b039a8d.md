...
**Bundle hash:** e0416f6e5eac5445 | **Risk:** high | **Math:** 10
...
| test_suite | PASS | 3.8s | .                                                                        [100%]
 |
| smoke | PASS | 11.2s | 14 modules imported OK |
| semgrep | PASS | 10.5s | semgrep findings: ERROR=0 WARNING=0 INFO=0; engine errors=0 |
| pip_audit | PASS | 34.3s | pip-audit findings: 0 vulnerabilities across 18 dep(s); scope: requirements file |
