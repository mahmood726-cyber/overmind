...
**Bundle hash:** fbbf9ebe200e4253 | **Risk:** high | **Math:** 10
...
| test_suite | PASS | 2.1s | .                                                                        [100%]
 |
| smoke | PASS | 74.2s | 40 modules imported OK |
| semgrep | PASS | 36.1s | semgrep findings: ERROR=0 WARNING=91 INFO=0; engine errors=0
91 advisory WARNING |
