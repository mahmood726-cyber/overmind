...
**Bundle hash:** 314cefb3124cd7a6 | **Risk:** high | **Math:** 10
...
| test_suite | PASS | 2.4s | .                                                                        [100%]
 |
| smoke | PASS | 76.7s | 40 modules imported OK |
| semgrep | PASS | 51.4s | semgrep findings: ERROR=0 WARNING=91 INFO=0; engine errors=0
91 advisory WARNING |
