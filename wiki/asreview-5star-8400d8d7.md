...
**Bundle hash:** ff1dc0d23190f977 | **Risk:** high | **Math:** 12
...
| test_suite | PASS | 4.4s | .........                                                                [100%]
 |
| smoke | PASS | 17.7s | 8 modules imported OK |
| semgrep | PASS | 14.9s | semgrep findings: ERROR=0 WARNING=1 INFO=0; engine errors=0
1 advisory WARNING f |
| pip_audit | SKIP | 0.0s | skipped |
| numerical | PASS | 2.0s | 12 values within tolerance |
