...
**Bundle hash:** 94078b49f5e57096 | **Risk:** high | **Math:** 14

## Health

| Witness | Verdict | Time | Detail |
|---------|---------|------|--------|
| test_suite | PASS | 9.1s | ...                                                                      [100%]
 |
| smoke | PASS | 14.4s | 14 modules imported OK |
| semgrep | PASS | 17.8s | semgrep findings: ERROR=0 WARNING=7 INFO=0; engine errors=0
