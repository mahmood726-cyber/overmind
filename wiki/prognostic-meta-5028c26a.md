...
**Bundle hash:** 4adc4bc076928f95 | **Risk:** high | **Math:** 20
...
| pip_audit | PASS | 50.6s | pip-audit findings: 0 vulnerabilities across 0 dep(s); scope: requirements file: |
| numerical | PASS | 0.5s | 11 values within tolerance |
...
|------|---------|-----------|------|------|
| 2026-04-19 | UNVERIFIED | 2/3 | 2.4s | 01a3bf500a616eb0 |
