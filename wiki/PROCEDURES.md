...
|--------|---------|-----|------|----------|-----------|
| UNKNOWN:evidenceor | s\user\AppData\Local\Programs\ | Manual investigation needed | 2 | 0 | 2026-04-08 |
| UNKNOWN:idea12-592 | ============================= | Manual investigation needed | 2 | 0 | 2026-04-08 |
| DEPENDENCY_ROT:gwam_utils | gwam_utils | Check if gwam_utils is installed: pip install gwam_utils | 1 | 0 | 2026-04-08 |
| DEPENDENCY_ROT:hfpef_calibrate | hfpef_calibrate | Check if hfpef_calibrate is installed: pip install hfpef_cal | 1 | 0 | 2026-04-08 |
| DEPENDENCY_ROT:statistical_framework | statistical_framework | Check if statistical_framework is installed: pip install sta | 1 | 0 | 2026-04-08 |
| SYNTAX_ERROR:repo300-en | ix
               ^
SyntaxErro | Fix the syntax error in the reported file | 1 | 0 | 2026-04-08 |
| TEST_FAILURE:asreview-5 | tiple_raters_fleiss
2 failed, | Read test output and fix failing tests | 1 | 0 | 2026-04-08 |
| TEST_FAILURE:ctgov-sear | est_ci_bounds_valid
20 failed, | Read test output and fix failing tests | 1 | 0 | 2026-04-08 |
| TIMEOUT:bayesianma | timed out | Check for WMI deadlock (Python 3.13), infinite loop, or slow | 1 | 0 | 2026-04-08 |
| TIMEOUT:cardioorac | timed out | Check for WMI deadlock (Python 3.13), infinite loop, or slow | 1 | 0 | 2026-04-08 |
...
| UNKNOWN:evidence-i | no tests ran in 0.03s | Manual investigation needed | 1 | 0 | 2026-04-08 |
| UNKNOWN:ipd-meta-p | dev.dedup_functions: This scri | Manual investigation needed | 1 | 0 | 2026-04-08 |
| UNKNOWN:pairwise70 | ck, subtests, tmp_path, tmp_pa | Manual investigation needed | 1 | 0 | 2026-04-08 |

## Anti-Recipes (never worked — do NOT retry)

| Recipe | Pattern | Seen | Resolved | Last Seen |
|--------|---------|------|----------|-----------|
| TIMEOUT:advanced-n | timed out | 4 | 0 | 2026-04-08 |
