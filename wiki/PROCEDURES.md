...
| UNKNOWN:evidence-i | no tests ran in 0.03s | Manual investigation needed | 2 | 0 | 2026-04-08 |
...
| DEPENDENCY_ROT:utils | utils | Check if utils is installed: pip install utils | 1 | 0 | 2026-04-08 |
| MISSING_FIXTURE:ubcma-4230 | newline="",
    )
FileNotFou | Restore or regenerate the missing file: , line 873, in get_h | 1 | 0 | 2026-04-08 |
| TIMEOUT:advanced-n | timed out | Check for WMI deadlock (Python 3.13), infinite loop, or slow | 1 | 0 | 2026-04-08 |
...
| UNKNOWN:evidence-i | no tests ran in 0.02s | Manual investigation needed | 1 | 0 | 2026-04-08 |

## Anti-Recipes (never worked — do NOT retry)

| Recipe | Pattern | Seen | Resolved | Last Seen |
|--------|---------|------|----------|-----------|
| TIMEOUT:advanced-n | timed out | 5 | 0 | 2026-04-08 |
| DEPENDENCY_ROT:gwam_utils | gwam_utils | 3 | 0 | 2026-04-08 |
| DEPENDENCY_ROT:hfpef_calibrate | hfpef_calibrate | 3 | 0 | 2026-04-08 |
| SYNTAX_ERROR:repo300-en | ix
               ^
SyntaxErro | 3 | 0 | 2026-04-08 |
| TEST_FAILURE:asreview-5 | tiple_raters_fleiss
2 failed, | 3 | 0 | 2026-04-08 |
| TEST_FAILURE:ctgov-sear | est_ci_bounds_valid
20 failed, | 3 | 0 | 2026-04-08 |
| UNKNOWN:ipd-meta-p | dev.dedup_functions: This scri | 3 | 0 | 2026-04-08 |
| UNKNOWN:pairwise70 | ck, subtests, tmp_path, tmp_pa | 3 | 0 | 2026-04-08 |
