...
**Bundle hash:** 25bffb1e50a5cc22 | **Risk:** high | **Math:** 7
...
| test_suite | PASS | 3.6s | .                                                                        [100%]
 |
| smoke | PASS | 28.3s | 40 modules imported OK |
| semgrep | PASS | 20.4s | semgrep findings: ERROR=0 WARNING=0 INFO=0; engine errors=0 |
