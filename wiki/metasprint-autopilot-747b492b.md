...
**Bundle hash:** 7efb46b5564baf72 | **Risk:** high | **Math:** 13
...
| test_suite | PASS | 16.1s | ..                                                                       [100%]
 |
| smoke | PASS | 13.8s | 40 modules imported OK |
| semgrep | PASS | 61.6s | semgrep findings: ERROR=0 WARNING=3 INFO=0; engine errors=8
3 advisory WARNING f |
| pip_audit | PASS | 50.2s | pip-audit findings: 0 vulnerabilities across 24 dep(s); scope: requirements file |
