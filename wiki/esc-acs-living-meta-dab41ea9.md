...
**Bundle hash:** 8db3e7ef3f7297fb | **Risk:** high | **Math:** 20
...
| test_suite | PASS | 4.6s | .                                                                        [100%]
 |
| smoke | PASS | 3.0s | 20 modules imported OK |
| semgrep | PASS | 27.5s | semgrep findings: ERROR=0 WARNING=0 INFO=0; engine errors=6 |
