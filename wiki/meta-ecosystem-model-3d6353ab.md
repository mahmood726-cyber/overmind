...
**Bundle hash:** eb015619871c4e0a | **Risk:** high | **Math:** 7
...
| test_suite | PASS | 0.3s | ==============
  ...
  [PASS] T |
| smoke | PASS | 11.2s | 2 modules imported OK |
| semgrep | PASS | 39.2s | semgrep findings: ERROR=0 WARNING=0 INFO=0; engine errors=0 |
| pip_audit | PASS | 44.5s | pip-audit findings: 0 vulnerabilities across 14 dep(s); scope: requirements file |
