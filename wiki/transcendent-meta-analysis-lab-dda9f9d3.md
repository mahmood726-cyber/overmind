...
**Bundle hash:** 2eeb5fa762a2cf66 | **Risk:** high | **Math:** 11
...
| test_suite | PASS | 4.2s | ............                                                             [100%]
 |
| smoke | PASS | 10.8s | 10 modules imported OK |
| semgrep | PASS | 14.3s | semgrep findings: ERROR=0 WARNING=0 INFO=0; engine errors=0 |
| pip_audit | PASS | 88.0s | pip-audit findings: 0 vulnerabilities across 0 dep(s); scope: requirements file: |
