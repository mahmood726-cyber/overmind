...
**Bundle hash:** 92e5ad85233dc1c3 | **Risk:** high | **Math:** 14
...
| test_suite | PASS | 4.3s | ................                                                         [100%]
 |
| smoke | PASS | 4.7s | 2 modules imported OK |
| semgrep | PASS | 18.6s | semgrep findings: ERROR=0 WARNING=0 INFO=0; engine errors=0 |
| pip_audit | PASS | 53.0s | pip-audit findings: 0 vulnerabilities across 10 dep(s); scope: requirements file |
...
|------|---------|-----------|------|------|
| 2026-04-25 | UNVERIFIED | 3/4 | 7.8s | 3920ef4c30ebfc87 |
