...
**Bundle hash:** e2e5d1d8eb6ef71e | **Risk:** high | **Math:** 20

## Health

| Witness | Verdict | Time | Detail |
|---------|---------|------|--------|
| test_suite | PASS | 17.5s | ....                                                                     [100%]
 |
| smoke | PASS | 91.6s | 40 modules imported OK |
| semgrep | PASS | 31.5s | semgrep findings: ERROR=0 WARNING=0 INFO=0; engine errors=0 |
| pip_audit | SKIP | 0.0s | skipped |
| numerical | PASS | 1.2s | 9 values within tolerance |
