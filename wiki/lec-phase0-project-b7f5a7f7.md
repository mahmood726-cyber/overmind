...
**Bundle hash:** 5dcb893a384c2070 | **Risk:** high | **Math:** 16
...
| test_suite | PASS | 7.3s | ...                                                                      [100%]
 |
| smoke | PASS | 111.8s | 40 modules imported OK |
| semgrep | PASS | 25.5s | semgrep findings: ERROR=0 WARNING=1 INFO=0; engine errors=0
1 advisory WARNING f |
| pip_audit | SKIP | 0.0s | skipped |
| numerical | PASS | 2.7s | 12 values within tolerance |
...
- **Test command:** `python -m pytest tests/test_discovery_epmc.py -q`
...
| 2026-05-09 | CERTIFIED | 5/6 | 159.4s | 15e3f4186b3f9ad0 |
| 2026-05-10 | CERTIFIED | 5/6 | 113.6s | 0d525675e083c8ab |
